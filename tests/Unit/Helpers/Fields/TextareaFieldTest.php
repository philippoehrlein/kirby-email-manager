...
class TextareaFieldTest extends ValidationHelperTest
{
    ...
    public function testTextareaTooShort()
    {
        $data = [$this->fieldKey => 'Zu kurz'];
        $errors = ValidationHelper::validateField($this->fieldKey, $this->fieldConfig, $data, $this->translations, $this->languageCode);
        $this->assertNotEmpty($errors);
    }

    public function testValidTextarea()
    {
        $data = [$this->fieldKey => 'Dies ist ein ausreichend langer Text für die Textarea.'];
        $errors = ValidationHelper::validateField($this->fieldKey, $this->fieldConfig, $data, $this->translations, $this->languageCode);
        $this->assertEmpty($errors);
    }

    public function testOptionalTextarea()
    {
